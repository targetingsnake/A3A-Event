...
Examples:
    ...
    private _UID = "123";
    [_UID,_keys] call FFPP_fnc_punishment_dataRem; // Removes keys "test" and "frost" in UID "123"
    [_UID,[]] call FFPP_fnc_punishment_dataRem;    // Removes UID "123" and all it's keys from _punishment_dataNamespace
