...
Example:
    [2009,15,6,13,45,30,420] call HR_fnc_systemTime_format_S;  // "2009-15-06 13:45:30:420"
    systemTimeUTC call HR_fnc_systemTime_format_S;
*/
params [
    "_year",
    "_month",
...
(str _year) + "-" + ((str _month) call HR_fnc_pad_2Digits) + "-" + ((str _day) call HR_fnc_pad_2Digits) + " " + ((str _hour) call HR_fnc_pad_2Digits) + ":" + ((str _minute) call HR_fnc_pad_2Digits) + ":" + ((str _second) call HR_fnc_pad_2Digits) + ":" + ((str _millisecond) call HR_fnc_pad_3Digits );
