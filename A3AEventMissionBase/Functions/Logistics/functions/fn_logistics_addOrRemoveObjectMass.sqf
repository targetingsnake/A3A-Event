...
["LogisticsInfo", parseText _text] remoteExec ["HR_fnc_customHint", remoteExecutedOwner];
["LogisticsInfo", parseText _text] remoteExec ["HR_fnc_customHint", crew _vehicle];
