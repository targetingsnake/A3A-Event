...
) exitWith {["Logistics", "Can't unload a static that's mounted"] remoteExec ["HR_fnc_customHint", remoteExecutedOwner]};

if (_vehicle getVariable ["LoadingCargo", false]) exitWith {["Logistics", "Cargo is already being unloaded from the vehicle"] remoteExec ["HR_fnc_customHint", remoteExecutedOwner]};
